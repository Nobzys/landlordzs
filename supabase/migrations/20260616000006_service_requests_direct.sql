...
-- ─── 6. Conversation context type ────────────────────────────────────────────
-- conversations.context_type is a free-text field; no enum change needed.
-- The accept action will insert context_type = 'service_request'.
