...
export const ROLE_NAV: Record<UserRole, NavItem[]> = {
  ...
  vendor: [
    ...
    { label: 'Add Product',    href: '/vendor/products/new',  icon: 'Plus',     exact: true },
  ...
  contractor: [
    ...
    { label: 'My Requests',  href: '/contractor/requests',     icon: 'ClipboardList' },
    { label: 'Portfolio',    href: '/contractor/portfolio',    icon: 'FolderOpen' },
    { label: 'My Profile',   href: '/account/profile',         icon: 'User' },
    { label: 'Wallet',       href: '/account/wallet',          icon: 'Wallet' },
  ],
  engineer: [
  ...
  architect: [
    ...
    { label: 'My Requests', href: '/architect/requests',     icon: 'ClipboardList' },
    { label: 'Portfolio',   href: '/architect/portfolio',    icon: 'FolderOpen' },
    { label: 'My Profile',  href: '/account/profile',        icon: 'User' },
    { label: 'Wallet',      href: '/account/wallet',         icon: 'Wallet' },
  ],
  lawyer: [
  ...
  maintenance: [
    ...
    { label: 'My Requests', href: '/maintenance/requests', icon: 'ClipboardList' },
    { label: 'My Profile',  href: '/account/profile',      icon: 'User' },
    { label: 'Wallet',      href: '/account/wallet',       icon: 'Wallet' },
  ],
  admin: [
