...
export const metadata: Metadata = { title: 'Service Requests — Contractor' }
...
export default async function ContractorRequestsPage() {
  ...
  // The contractor's own submitted quotations (pending + accepted + rejected)
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-8 space-y-8">
      ...
      {/* Open requests — all visible to professionals */}
      <section className="space-y-4">
