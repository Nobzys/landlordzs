...
export const metadata: Metadata = { title: 'Edit Portfolio Project — Contractor' }
...
export default async function EditPortfolioItemPage({ params }: EditPortfolioPageProps) {
