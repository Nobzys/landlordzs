...
export const metadata: Metadata = { title: 'Service Requests — Architect' }
...
export default async function ArchitectRequestsPage() {
  ...
  // The architect's own submitted quotations
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
