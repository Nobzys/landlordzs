...
export const metadata: Metadata = { title: 'Edit Portfolio Project — Architect' }
...
export default async function EditArchitectPortfolioItemPage({ params }: EditPortfolioPageProps) {
