  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-5">
      ...
      <div className="grid grid-cols-2 gap-4">
        <div className="space-y-1.5">
          <label className="text-sm font-medium" htmlFor="budget_min">Min budget (XAF)</label>
          <input
            id="budget_min"
            name="budget_min"
            type="number"
        ...
        <div className="space-y-1.5">
          <label className="text-sm font-medium" htmlFor="budget_max">Max budget (XAF)</label>
          <input
            id="budget_max"
            name="budget_max"
            type="number"
      ...
      <div className="space-y-1.5">
        <label className="text-sm font-medium" htmlFor="preferred_date">Preferred date</label>
        <input
          id="preferred_date"
          name="preferred_date"
          type="date"
      ...
      <div className="space-y-1.5">
        <label className="text-sm font-medium" htmlFor="contact_phone">Contact phone (optional)</label>
        <input
          id="contact_phone"
          name="contact_phone"
          type="tel"
