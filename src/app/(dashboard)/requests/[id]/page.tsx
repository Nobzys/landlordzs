...
import { REQUEST_TYPES_BY_ROLE, STATUS_LABELS } from '@/types/service-request'
...
export default async function RequestDetailPage({ params }: { params: Promise<Params> }) {
  ...
  // Fetch request (RLS: only visible to requester, provider, admin)
  ...
  // Fetch requester + provider profiles in parallel
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-8 space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        <div className="rounded-xl border bg-card p-4 space-y-2">
          ...
          <div className="flex items-center gap-3">
            <PartyAvatar name={requesterName} initial={requesterInitial} avatarUrl={requester?.avatar_url} />
        ...
        {provider && (
          <div className="rounded-xl border bg-card p-4 space-y-2">
            ...
            <div className="flex items-center gap-3">
              <PartyAvatar name={providerName} initial={providerInitial} avatarUrl={provider?.avatar_url} />
              <div className="min-w-0">
                ...
                {provider?.slug && (
                  <Link href={`/professionals/${provider.role}/${provider.slug}`}
      ...
      <div className="space-y-3">
        ...
        {/* Escrow hook — shown to requester when accepted and no escrow yet */}
          ...
          <div className="rounded-xl border border-emerald-200 bg-emerald-50 p-4 flex items-center justify-between gap-4">
            <div>
              ...
              <p className="text-xs text-emerald-700 mt-0.5">
                Start an escrow to hold funds until the work is complete.
              </p>
            </div>
            <LinkButton
        ...
        {/* Review — requester after completion */}
