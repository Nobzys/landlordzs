...
export const metadata: Metadata = { title: 'My Portfolio — Engineer' }
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-8 space-y-6">
      <div className="flex items-center justify-between">
        ...
        <LinkButton href="/engineer/portfolio/new">
      ...
      {portfolio.length === 0 ? (
        <div className="text-center py-16 border rounded-xl text-muted-foreground">
          ...
          <LinkButton href="/engineer/portfolio/new">Add Your First Project</LinkButton>
        </div>
      ) : (
              ...
              <div key={item.id} className="rounded-xl border bg-card overflow-hidden flex flex-col">
                ...
                <div className="p-4 flex flex-col gap-2 flex-1">
                  ...
                  <div className="flex items-center gap-2 mt-auto pt-3 border-t">
                    <Link
                      href={`/engineer/portfolio/${item.id}/edit`}
